...
<head>
    ...
    <title>Login - Notizen</title><link rel="icon" type="image/svg+xml" href="/static/icons/book-plus.svg">
...
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width,initial-scale=1.0">
    <title>{{ title }} - Geteilte Notiz</title><link rel="icon" type="image/svg+xml" href="/static/icons/book-plus.svg">
    <link rel="stylesheet" href="/static/style.css?v={{ v }}">
...
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width,initial-scale=1.0">
    <title>Notizen</title><link rel="icon" type="image/svg+xml" href="/static/icons/book-plus.svg">
    <link rel="stylesheet" href="/static/style.css?v={{ v }}">
...
<div class="menu-row" style="opacity: 0.5; font-size: 0.75em;" onclick="window.open('https://github.com/ipod86/Notizen', '_blank')">
    ...
    <div id="history-modal" class="modal-overlay">
        <div class="modal" style="width: 700px; max-width: 95vw;">
            ...
            <div id="history-list" style="text-align:left; max-height: 60vh; overflow-y: auto; margin-bottom: 20px;">
                Lade...
            </div>
            <div class="modal-btns">
